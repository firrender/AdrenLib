...
import club.adren.lib.utils.CheckNetwork;
import club.adren.lib.utils.StringUtils;
 ...
 * Creator: adren
 * CreTime: 2020/11/3
 * Descrip: 网络请求工具类, 使用时请在"Application"下初始化。
 */
public class HttpUtils {
    ...
    public final static String API_MOFANG = "http://mtapi.ruanmei.com/";
    ...
    private OkHttpClient getUnsafeOkHttpClient() {
        try {
            ...
            okBuilder.addInterceptor(new HttpLoggingInterceptor()
                    .setLevel(Config.TYPE == Config.TYPE_RELEASE ? HttpLoggingInterceptor.Level.NONE : HttpLoggingInterceptor.Level.BODY));
            ...
            if (Config.TYPE == Config.TYPE_RELEASE) okBuilder.proxy(Proxy.NO_PROXY);
